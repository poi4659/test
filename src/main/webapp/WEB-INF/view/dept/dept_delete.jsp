...
<div class="card-body">
<form action="./DeptDelete.do" method="post" id="sign_dept">
<fieldset>
...
<div class="row">
<div class="col-md-4">
<a href="./DeptSelect.do" class="btn btn-primary btn-block">
부서 목록
</a>
</div>
<div class="col-md-4">
<a href="./DeptInsertView.do" class="btn btn-success btn-block">
부서 입력
</a>
</div> <div class="col-md-4">
<a href="./DeptUpdateView.do?deptno=${param.deptno}" class="btn btn-warning btn-block">
부서 수정
</a>
</div>
</div>
