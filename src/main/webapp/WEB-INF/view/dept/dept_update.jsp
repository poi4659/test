...
<div class="row">
<div class="col-md-4">
<a href="./DeptSelect.do" class="btn btn-primary btn-block"> 부서 목록 </a>
</div>
<div class="col-md-4">
<a href="./DeptInsertView.do" class="btn btn-success btn-block"> 부서 입력 </a>
</div>
<div class="col-md-4">
<a href="./DeptDeleteView.do?deptno=${param.deptno}" class="btn btn-danger btn-block">
부서 삭제
</a>
</div>
</div>
